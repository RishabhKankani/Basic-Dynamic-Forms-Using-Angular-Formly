...
export class UserService {
  ...
  getUser() {
    return this.http.get<{ firstName: string, lastName: string, Gender: string, number: string, email: string, address: string, password: string, passwordConfirm: string }>('assets/json-powered/user.json');
  }
